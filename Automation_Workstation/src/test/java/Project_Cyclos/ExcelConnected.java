...
public class ExcelConnected {
	...
	public void testLogin() throws Exception 
	{
		...
		for(int i=1;i<=s.getLastRowNum();i++)
		{
			...
			driver.findElement(By.xpath("//input[@type='text']")).sendKeys(s.getRow(i).getCell(0).getStringCellValue());
			String uname=driver.findElement(By.xpath("//input[@type='text']")).getAttribute("value");
			
			// Enter password
			driver.findElement(By.xpath("//input[@type='password']")).sendKeys(s.getRow(i).getCell(1).getStringCellValue());
